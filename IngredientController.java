...
public class IngredientController {
    ...
    public void readJTable() throws SQLException{
        ...
        for (Ingredient ingredient : dao.readAll()) {
            BigDecimal unitCost = BigDecimal.valueOf(ingredient.getIngredientUnitCost());
            BigDecimal unitQuantity = BigDecimal.valueOf(ingredient.getIngredientUnitQuantity());
            BigDecimal minQuantity = BigDecimal.valueOf(ingredient.getIngredientMinQuantity());

            int unitCostInteger = unitCost.multiply(BigDecimal.valueOf(100)).intValue();
            int unitQuantityInteger = unitQuantity.multiply(BigDecimal.valueOf(100)).intValue();
            int minQuantityInteger = minQuantity.multiply(BigDecimal.valueOf(100)).intValue();
