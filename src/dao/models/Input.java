...
public class Input extends EntityId{
    ...
    private int ingredientWuantity;
    ...
    public int getIngredientWuantity() {
        return ingredientWuantity;
    }

    public void setIngredientWuantity(int ingredientWuantity) {
        this.ingredientWuantity = ingredientWuantity;
    }
